...
\begin{table}[H]
    ...
    \hline
    \rowcolor[rgb]{ .851,  .882,  .949} \textbf{Beale's -Centralised} & 4205  & 3842  & 4775  & 4417 \\
    \hline
    \rowcolor[rgb]{ .851,  .882,  .949} \textbf{Beale's -Distributed} & 5291  & 5630  & 7153  & 7860 \\
    \hline
    \rowcolor[rgb]{ 1,  .949,  .8} \textbf{Booth's -Centralised} & 2910  & 3243  & 3634  & 2805 \\
    \hline
    \rowcolor[rgb]{ 1,  .949,  .8} \textbf{Booth's -Distributed} & 4331  & 4846  & 6197  & 7541 \\
    \hline
    \rowcolor[rgb]{ .886,  .937,  .855} \textbf{Easom's -Centralised} & 2364  & 2297  & 2313  & 2388 \\
    \hline
    \rowcolor[rgb]{ .886,  .937,  .855} \textbf{Easom's -Distributed} & 3551  & 3287  & 3925  & 4385 \\
    \hline
   \end{tabular}}%
...
\begin{table}[H]
    ...
    & \multicolumn{1}{l|}{\textbf{TTS - 2 Swarms}} & \multicolumn{1}{l|}{\textbf{TTS - 4 Swarms}} & \multicolumn{1}{l|}{\textbf{TTS - 8 Swarms}} & \multicolumn{1}{l|}{\textbf{TTS - 10 Swarms}} \\
    \hline
    \rowcolor[rgb]{ .851,  .882,  .949} \textbf{Beale's -Centralised} & 112258 & 119800 & 112751 & 160899 \\
    \hline
    \rowcolor[rgb]{ .851,  .882,  .949} \textbf{Beale's -Distribributed} & 56502 & 48906 & 49696 & 51248 \\
    \hline
    \rowcolor[rgb]{ 1,  .949,  .8} \textbf{Booth's -Centralised} & 102709 & 103364 & 102856 & 131270 \\
    \hline
    \rowcolor[rgb]{ 1,  .949,  .8} \textbf{Booth's -Distribributed} & 48322 & 39878 & 36861 & 49330 \\
    \hline
    \rowcolor[rgb]{ .886,  .937,  .855} \textbf{Easom's -Centralised} & 50887 & 51263 & 52918 & 78160 \\
    \hline
    \rowcolor[rgb]{ .886,  .937,  .855} \textbf{Easom's -Distribributed} & 29327 & 23923 & 24623 & 26300 \\ \hline
   \end{tabular}}%
...
\begin{table}[H]
    ...
    \end{tabular}}%
  \caption{Centralised Easom's Results}    
  \label{tab:CentralisedEasomTTS}%
\end{table}%

Table \ref{tab:CentralisedBoothsTTS} shows the full averaged result set for the centralised Booth's function TTS.
...
\begin{table}[H]
    ...
    \hline
    \end{tabular}}%
  \caption{Centralised Booth's TTS} 
  \label{tab:CentralisedBoothsTTS}%
\end{table}%

Table \ref{tab:CentralisedBealeTTS} shows the full averaged result set for the centralised Beale's function TTS.
...
\begin{table}[H]
   ...
   \hline
    ...
    \hline
    \end{tabular}}%
  \caption{Centralised Beale's TTS} 
  \label{tab:CentralisedBealeTTS}%
\end{table}%

Table \ref{tab:DistributedEasomTTS} shows the full averaged result set for the distributed Easom's function TTS.
...
\begin{table}[H]
   ...
   \hline
    ...
    \hline
    \end{tabular}}%
  \caption{Distributed Easom's TTS} 
  \label{tab:DistributedEasomTTS}%
\end{table}%

Table \ref{tab:DistributedBothsTTS} shows the full averaged result set for the distributed Booth's function TTS.
...
\begin{table}[H]
    ...
    \hline
    \end{tabular}}%
  \caption{Distributed Booth's TTS} 
  \label{tab:DistributedBothsTTS}%
\end{table}%

Table \ref{tab:DistributedBealeTTS} shows the full averaged result set for the distributed Beale's function TTS.
...
\begin{table}[H]
   ...
   \hline
    ...
    \hline
    \end{tabular}}%
  \caption{Distributed Beale's TTS} 

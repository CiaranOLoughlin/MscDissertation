...
public class DistibutedService {
    ...
    public Response runDistributedCallingSystem(int numberOfParticles, List<String> baseUrls, ConfigVariables configVariables) {
        ...
        List<ResultList> multiSwarmResults = utils.createMultiSwarmResultSet(numberOfSwarms);
    ...
    public boolean setInitialisedSwarm(int swarmId, int numberOfParticles, ConfigVariables configVariables){

...
public class Swarm {
    ...
    private Function function; // The function to search.
    ...
    private static final double DEFAULT_END_RANGE = 1000;
     ...
     */
    public Swarm (Function function, int particles, int epochs) {
     ...
     */
    public Swarm (Function function, int particles, int epochs, double inertia, double cognitive, double social) {
